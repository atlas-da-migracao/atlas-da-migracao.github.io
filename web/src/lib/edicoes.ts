 ...
 */
export type Censo = "2022" | "2010";
export const CENSOS: Censo[] = ["2022", "2010"];
...
export interface Edicao {
   ...
   *  publicados é sempre "tempo"/"frequencia" nas duas edições) usado para escolher qual
   *  entrada de DIMENSOES_PENDULAR exibir: 2022 usa a paleta padrão, 2010 usa a variante
   *  "*2010" (pergunta e faixas diferentes, ver docs/METODOLOGIA.md). */
