...
- Gerado em: 2026-09-05 23:11 (fuso local)
...
| `rm_mig_pendular.parquet` | 5,350 | 0.1 MB | `02aa8aca8a07` |
| `rm_mig_pendular_resumo.parquet` | 1,375 | 0.0 MB | `d40a3f3772a7` |
| `rm_resumo.parquet` | 81 | 0.0 MB | `9680904dcac9` |
