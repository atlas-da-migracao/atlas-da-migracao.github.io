...
- Versão dos dados: **1.0.0-2000**
- Gerado em: 2026-09-14 21:34 (fuso local)
- Fonte: IBGE, Censo Demográfico 2000, microdados da amostra (acesso controlado).
...
- R1: 52,655 fluxos publicados, todos com n>=5 e domicílios>=3
